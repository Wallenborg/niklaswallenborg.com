...
<body>
    ...
    <main>
        <section>
            <h1 class="pstartpage">Low-Life, High-Tech</h1>
            <p>”A good GIF should loop forever”</p>
            <img src="img/lowlife/lowlife.jpg">
            <p class="textleft">To see all GIFs press enter.</p>
            <p><a href="gif.html"><button class="button1">Enter</button></a></p>
        </section>
    </main>
    <hr>
    <p><a href="index.php">Back</a></p>
