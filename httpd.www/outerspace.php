...
<body>
    ...
    <main>
        <section>
            <h1 class="pstartpage">Outer Space as Public Space</h1>
        <!-- slideshow -->
            <div class="slideshow-container">
            <div class="mySlides fade">
                <img src="img/outspace/outs01.jpg" style="width: 400px"/>
            </div>
            <div class="mySlides fade">
                <img src="img/outspace/outs02.jpg" style="width: 400px"/>
            </div>
            <div class="mySlides fade">
                <img src="img/outspace/outs03.jpg" style="width: 400px"/>
            </div>
            <div class="mySlides fade">
                <img src="img/outspace/outs04.jpg" style="width: 400px"/>
            </div>
